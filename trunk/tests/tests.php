...
echo "<h3>Email address validation test suite version 1.9</h3>\n";
...
echo unitTest("\"null \\ \"@char.com", true, "can have escaped null character");
echo unitTest("\"null  \"@char.com", false, "cannot have unescaped null character");
echo unitTest("null\\ @char.com", false, "escaped null must be in quoted string");
echo unitTest("cdburgess+!#\$%&'*-/=?+_{}|~test@gmail.com", true, "Example given in comments");
?>
</body>
